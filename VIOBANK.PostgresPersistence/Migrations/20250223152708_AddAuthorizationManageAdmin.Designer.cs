...
namespace VIOBANK.PostgresPersistence.Migrations
{
    ...
    [Migration("20250223152708_AddAuthorizationManageAdmin")]
    partial class AddAuthorizationManageAdmin
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VIOBANK.Domain.Models.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("VIOBANK.Domain.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("VIOBANK.PostgresPersistence.Entities.RolePermissionEnity", b =>
                {
            ...
            modelBuilder.Entity("VIOBANK.PostgresPersistence.Entities.UserRoleEntity", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("VIOBANK.PostgresPersistence.Entities.RolePermissionEnity", b =>
                {
                    b.HasOne("VIOBANK.Domain.Models.Permission", null)
                        .WithMany()
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VIOBANK.Domain.Models.Role", null)
                        .WithMany()
